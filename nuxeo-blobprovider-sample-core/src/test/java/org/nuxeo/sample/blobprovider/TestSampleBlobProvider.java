...
public class TestSampleBlobProvider {
    ...
    public void testBlobProvider() throws Exception {
        ...
        /*
         * The setPropertyValue is used to set a document property
         * Here we set the document title
         */
        doc.setPropertyValue("dc:title","MyTestDocument");

        /*
         * The BlobManager object contains a registry of all the providers declared in the application
         * The Framework object provides static methods that you can use to obtain an implementation object of
         * a service. Here we use it to get the BlobManager
         */
        BlobManager blobManager = Framework.getService(BlobManager.class);

        /*
         * Our sample blob provider is declared in the file blobprovider-test.xml which is loaded by the runtime.
         * If you have a look at it, you'll see that it declares a blob provider "sampleProvider"
         * which implementation class is SampleBlobProvider
         */
        ...
        /*
         * We can now set the blob in the document using the same method as previously.
         * Since our blob provider does not store files, what is saved in the repository is really
         * just the descriptor (the key, mimetype and filename).
        ...
        /*
         * To download the blob locally we just use the getStream method of the blob object and
